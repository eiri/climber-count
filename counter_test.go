...
func TestLastUpdate_UnmarshalJSON(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			expected: time.Date(time.Now().Year(), time.Now().Add(-24*time.Hour).Month(), time.Now().Add(-24*time.Hour).Day(), time.Now().Hour(), time.Now().Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with days ago",
			input:    `"Lastupdated:&nbsp2daysago"`,
			expected: time.Date(time.Now().Year(), time.Now().Add(-24*time.Hour).Month(), time.Now().Add(-48*time.Hour).Day(), time.Now().Hour(), time.Now().Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with one hour ago",
			input:    `"Lastupdated:&nbsp1hourago"`,
			expected: time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), time.Now().Add(-1*time.Hour).Hour(), time.Now().Add(-1*time.Hour).Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with hours ago",
			input:    `"Lastupdated:&nbsp3hoursago"`,
			expected: time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), time.Now().Add(-3*time.Hour).Hour(), time.Now().Add(-3*time.Hour).Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with one minute ago",
			input:    `"Lastupdated:&nbsp1minago"`,
			expected: time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), time.Now().Add(-1*time.Minute).Hour(), time.Now().Add(-1*time.Minute).Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with minutes ago",
			input:    `"Lastupdated:&nbsp12minsago"`,
			expected: time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), time.Now().Add(-12*time.Minute).Hour(), time.Now().Add(-12*time.Minute).Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Valid time with now",
			input:    `"Lastupdated:&nbspnow "`,
			expected: time.Date(time.Now().Year(), time.Now().Month(), time.Now().Day(), time.Now().Hour(), time.Now().Minute(), 0, 0, time.UTC),
			hasError: false,
		},
		{
			name:     "Null input",
